...
<t:layout>
	...
	<div class="col-sm-6">
		<!--  <form method="post" action="CustomerTransactionConfirmation"> -->
			...
			<input id="cost" type="hidden" value="${transaction.application.cost}" />
			<div class="panel panel-default">
				<div class="panel-heading">
					Payment Info
				</div>
				...
				<div class="panel-footer clearfix">
					...
					<input id="confirmPaymentBtn" class="btn btn-primary pull-right" type="button" value="Confirm Payment" />
